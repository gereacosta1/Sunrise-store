      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="space-y-8 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-orange-100 font-light max-w-2xl mx-auto leading-relaxed">
            La nueva era de movilidad eléctrica ha llegado. Descubre nuestros scooters y motocicletas eléctricas de última generación.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
            ...
            >
              ...
              <span className="font-medium">Conocer financiamiento</span>
            </button>
          </div>
        </div>
      </div>
