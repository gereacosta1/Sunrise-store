          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Paga en cuotas con Affirm según elegibilidad. Sujeto a aprobación.{' '}
                <a 
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Cuotas desde $89/mes</h3>
                  <p className="text-gray-600">Planes de financiamiento flexibles adaptados a tu presupuesto</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Aprobación instantánea</h3>
                  <p className="text-gray-600">Conoce tu aprobación en menos de 30 segundos</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Sin penalizaciones</h3>
                  <p className="text-gray-600">Paga antes de tiempo sin cargos adicionales</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-8 text-white">
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-orange-100">
                  Tecnología financiera líder para tus compras
                </p>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mt-8">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      ...
                      <div className="text-sm text-orange-100">Interés inicial</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold">24</div>
                      <div className="text-sm text-orange-100">Meses máximo</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold">5min</div>
                      <div className="text-sm text-orange-100">Proceso</div>
                    </div>
                  </div>
                </div>
              </div>
